...
;			   8) The program loops generating another problem if the user wants to solve
...
closeWndw		BYTE 0Dh,0Ah,"Pres Any Key to Close...",0
...
comboProblem:
	...
	mov		eax, continue
	cmp		eax, loopCtrl					; Compare user's response to loopCtrl			
	je		comboProblem					; If they are equal, the user wants to continue. Loop for a new problem.
	...
	output		closeWndw					; Pause to keep window open
	call		ReadChar					; User enters any character to close
...
;		 5) Variables nSet & rSub are declared but uninitialized
; CHANGES      : n/a
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
